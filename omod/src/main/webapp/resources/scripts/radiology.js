...
dojo.addOnLoad( function() {
	...
	dojo.event.topic.subscribe("aSearch/select", 
		function(msg) {
			selectConcept('investigationNames',  msg.objs, answerSearch);
		}
	);
	...
	dojo.event.topic.subscribe("cSearch/select", 
		function(msg) {
			selectConcept('confidentialTestNames',  msg.objs, cSearch);
		}
	);
		
	
});
function selectConcept(nameList,  conceptList, widget) {
...
function removeItem(nameList,  delim)
{
